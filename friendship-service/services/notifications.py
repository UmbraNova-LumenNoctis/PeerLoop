"""Notification delivery helpers for friendship service."""
...
def send_notification(
    ...
    """Send an internal notification if service credentials are configured.
    ...
    Args:
        ...
        actor_id (str | None): Identifier for actor.
