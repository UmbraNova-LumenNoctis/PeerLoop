"""Authentication helpers for friendship routes."""
...
def resolve_user_id(x_user_id: str | None, x_access_token: str | None) -> str | None:
    """Resolve current user id from trusted header or Supabase access token.
    ...
    Returns:
        str | None: Current user id from trusted header or Supabase access token.
    """
    if x_user_id:
        return x_user_id
