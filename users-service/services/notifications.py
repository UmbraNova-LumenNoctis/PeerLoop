"""Notification helper for users service."""
...
def send_notification(
    ...
    """Send internal notification request and ignore delivery failures.
    ...
    if response.status_code not in (200, 201):
        logger.warning("Notification request returned status %s: %s", response.status_code, response.text)
